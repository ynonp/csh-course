...
1. Write a shell script that takes a file name as a command line argument and prints its contents backwards (from last line to first)
...
5. Print a list of all the  file extensions in current folder using only shell builtins (no `cut` or `awk`)
